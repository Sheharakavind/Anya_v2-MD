...
module.exports = {
     ...
     */
    botname: process.env.BotName || "Omax Skiper v2",
    ...
    ownernumber: process.env.Owner_Number || "94712438904",
    ...
    sessionId: process.env.SESSION_ID || "LLEKTQkJapj2MX0rc_A_N_Y_A_V_2_XoX",
